...
# App finden
APP_PATH="$DERIVED_DATA_PATH/Build/Products/$BUILD_CONFIGURATION/Whispy.app"
...
if [ "$INSTALL_APP" = true ]; then
    ...
    INSTALL_DEST="$APPS_DIR/Whispy.app"
    if [ ! -w "$APPS_DIR" ]; then
...
echo "4. In Whispy deinen eigenen OpenAI API Key eintragen"
